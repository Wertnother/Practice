...
<div id="mainContent" class="container">
	<div id="infoblock">
		<div id="infohead">
			<h1>Movie</h1> <em>A Schema.org Type</em>
			<br/> </div>
		<div class="superPaths"> <a href="/Thing" class="core" title="Thing">Thing</a> > <a href="/CreativeWork" class="core" title="CreativeWork">CreativeWork</a> > <a href="/Movie" class="core" title="Movie">Movie</a>
			<br/> </div>
	</div>
	<!-- Description of term -->
	<div class="description">Кино.</div>
	<table class="table table-bordered definition-table">
		...
		<!-- Properties for Term: Movie-->
		<tbody>
			<tr class="supertype">
				<th class="supertype-name" colspan="3"><span style="vertical-align: inherit;"><span style="vertical-align: inherit;">Свойства из </span></span><span style="vertical-align: inherit;"><span style="vertical-align: inherit;">фильма</span></span>
				</th>
			</tr>
			<tr>
			...
			<tr>
				<th class="prop-nam"><code> subtitleLanguage</code></th>
			...
			<tr>
				...
				<td class="prop-desc"><span style="vertical-align: inherit;"><span style="vertical-align: inherit;">EIDR</span></span><span style="vertical-align: inherit;"><span style="vertical-align: inherit;"> (развлечения идентификатор регистрации) </span></span><span style="vertical-align: inherit;"><span style="vertical-align: inherit;">идентификатор</span></span><span style="vertical-align: inherit;"><span style="vertical-align: inherit;"> , представляющий в наиболее общем / абстрактном уровне, произведение кино или телевидения. </span></span>
					<br />
					<br /><span style="vertical-align: inherit;"><span style="vertical-align: inherit;"> Например, фильм, известный как &laquo;Охотники за привидениями&raquo;, имеет заголовок EIDR &laquo;10.5240 / 7EC7-228A-510A-053E-CBB8-J&raquo;. </span><span style="vertical-align: inherit;">У этого названия (или произведения) может быть несколько вариантов, которые EIDR называет &laquo;правками&raquo;. </span><span style="vertical-align: inherit;">Смотрите </span></span><span style="vertical-align: inherit;"><span style="vertical-align: inherit;">editEIDR</span></span><span style="vertical-align: inherit;"><span style="vertical-align: inherit;"> . </span></span>
					<br />
					<br /><span style="vertical-align: inherit;"><span style="vertical-align: inherit;"> Поскольку типы schema.org, такие как </span></span><span style="vertical-align: inherit;"><span style="vertical-align: inherit;">Movie</span></span><span style="vertical-align: inherit;"><span style="vertical-align: inherit;"> и </span></span><span style="vertical-align: inherit;"><span style="vertical-align: inherit;">TVEpisode,</span></span><span style="vertical-align: inherit;"><span style="vertical-align: inherit;"> могут использоваться как для произведений, так и для их нескольких выражений, можно использовать </span><span style="vertical-align: inherit;">только </span></span><span style="vertical-align: inherit;"><span style="vertical-align: inherit;">titleEIDR</span></span><span style="vertical-align: inherit;"><span style="vertical-align: inherit;"> (для общего описания) или вместе с </span></span><span style="vertical-align: inherit;"><span style="vertical-align: inherit;">editEIDR</span></span><span style="vertical-align: inherit;"><span style="vertical-align: inherit;"> для более специфичного для редактирования описания. </span></span>
				</td>
			</tr>
			<tr>
				<th class="prop-nam"><code> trailer</code></th>
				<td class="prop-ect"><span style="vertical-align: inherit;"><span style="vertical-align: inherit;">VideoObject</span></span>
				</td>
				<td class="prop-desc"><span style="vertical-align: inherit;"><span style="vertical-align: inherit;">Трейлер фильма или телесериала / радиосериала, сезон, серия и т. Д. </span></span>
				</td>
			</tr>
