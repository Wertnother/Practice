...
@section('title')AudioObject @endsection
...
<div id="mainContent" class="container">
	<div id="infoblock">
		<div id="infohead">
			<h1>AudioObject</h1> <em>A Schema.org Type</em>
			<br/> </div>
		<div class="superPaths"> <a href="/Thing" class="core" title="Thing">Thing</a> > <a href="/CreativeWork" class="core" title="CreativeWork">CreativeWork</a> > <a href="/MediaObject" class="core" title="MediaObject">MediaObject</a> > <a href="/AudioObject" class="core" title="AudioObject">AudioObject</a>
			<br/> </div>
		<div class="description">Аудиофайл.</div>
	</div>
	<table class="table table-bordered definition-table">
		...
		<tbody>
			<tr class="supertype">
				<th class="supertype-name" colspan="3"><span style="vertical-align: inherit;"><span style="vertical-align: inherit;">Свойства из </span></span><span style="vertical-align: inherit;"><span style="vertical-align: inherit;">AudioObject</span></span>
				</th>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="prop-desc"><span style="vertical-align: inherit;"><span style="vertical-align: inherit;">Указывает на страницу, описывающую, как можно приобрести или иным образом приобрести лицензии для текущего элемента. </span></span>
				</td>
			</tr>
			<tr>
	...
	<div class="row border  h-100 p-5 text-white bg-dark">
        ...
        <div>
	<div>
		&lt;div&nbsp;itemscope&nbsp;itemtype="https://schema.org/AudioObject"&gt;&nbsp;&lt;span&nbsp;itemprop="name"&gt;&nbsp;&lt;b&gt;&nbsp;12oclock_girona.mp3&nbsp;&lt;/b&gt;&nbsp;&lt;/span&gt;
	</div>
	<div>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;script&nbsp;type="text&nbsp;/&nbsp;javascript"&gt;&nbsp;var&nbsp;fo&nbsp;=&nbsp;new&nbsp;FlashObject&nbsp;(&nbsp;"http://google.com/flash/preview-player.swf"&nbsp;,&nbsp;&laquo;flashPlayer_719&raquo;&nbsp;,&nbsp;&laquo;358&raquo;&nbsp;,&nbsp;&laquo;16&raquo;&nbsp;,&nbsp;&laquo;6&raquo;&nbsp;,&nbsp;&laquo;#FFFFFF&raquo;&nbsp;);&nbsp;fo&nbsp;.&nbsp;addVariable&nbsp;(&nbsp;"url"&nbsp;,&nbsp;"http://media.freesound.org/data/0/previews/719__elmomo__12oclock_girona_preview.mp3"&nbsp;);&nbsp;fo&nbsp;.&nbsp;addVariable&nbsp;(&nbsp;"автозапуск"&nbsp;,&nbsp;"0"&nbsp;);&nbsp;fo&nbsp;.&nbsp;написать&nbsp;(&nbsp;"flashcontent_719"&nbsp;);&nbsp;&lt;/script&gt;
	</div>
	<div>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;meta&nbsp;itemprop="encodingFormat"&nbsp;content="audio&nbsp;/&nbsp;mpeg"&nbsp;/&gt;
	</div>
	<div>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;meta&nbsp;itemprop="contentUrl"&nbsp;content="http://media.freesound.org/data/0/previews/719__elmomo__12oclock_girona_preview.mp3"&nbsp;/&gt;&nbsp;&lt;span&nbsp;class="description"&gt;&nbsp;
	</div>
	<div>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;meta&nbsp;itemprop&nbsp;=&nbsp;"duration"&nbsp;content&nbsp;=&nbsp;"T0M15S"&nbsp;/&gt;&nbsp;&nbsp;&nbsp;
	</div>
	<div>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;span&nbsp;itemprop&nbsp;=&nbsp;"description"&nbsp;&gt;&nbsp;Снято&nbsp;на&nbsp;террасе&nbsp;Жироны&nbsp;воскресным&nbsp;утром&nbsp;&lt;/span&gt;&nbsp;&lt;/span&gt;
	</div>
	<div>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/div&gt;
	</div>
		...
		<div class="col-sm-6">
			<div itemscope itemtype="https://schema.org/AudioObject"> <span itemprop="name"> <b> 12oclock_girona.mp3 </b> </span>
				<script type="text / javascript"> var fo = new FlashObject ( "http://google.com/flash/preview-player.swf" , «flashPlayer_719» , «358» , «16» , «6» , «#FFFFFF» ); fo . addVariable ( "url" , "http://media.freesound.org/data/0/previews/719__elmomo__12oclock_girona_preview.mp3" ); fo . addVariable ( "автозапуск" , "0" ); fo . написать ( "flashcontent_719" ); </script>
				<meta itemprop="encodingFormat" content="audio / mpeg" />
				<meta itemprop="contentUrl" content="http://media.freesound.org/data/0/previews/719__elmomo__12oclock_girona_preview.mp3" /> <span class="description"> 
      <meta itemprop = "duration" content = "T0M15S" />   
      <span itemprop = "description" > Снято на террасе Жироны воскресным утром </span> </span>
