...
@section('title')CreativeWork @endsection
...
<div id="mainContent" class="container">
	<div id="infoblock">
		<div id="infohead">
			<h1>CreativeWork</h1> <em>A Schema.org Type</em>
			<br/> </div>
		<div class="superPaths"> <a href="/Thing" class="core" title="Thing">Thing</a> > <a href="/CreativeWork" class="core" title="CreativeWork">CreativeWork</a>
			<br/> </div>
	</div>
	<div class="description">Самый общий вид творческой работы, включая книги, фильмы, фотографии, программы и т. Д.</div>
...
&lt;/div&gt;
			...
			<div class="col-sm-6">
				<div itemscope itemtype="https://schema.org/CreativeWork"> <img itemprop="image" alt="Обложка Fall of Man" src="https://upload.wikimedia.org/wikipedia/ru/archive/9/95/20200321233733%21Resistance_fall_of_man_boxcover.jpg" />
					<br/><span itemprop="name"> Сопротивление 3: Падение человека </span>
					<br/>Aвтор: <span itemprop="author"> Sony </span>,
					<br/>Платформа: Playstation 3
					<br/>Оценка: <span itemprop="contentRating"> Для взрослых </span> </div>
			</div>
		</div>
		<div class="row border  h-100 p-5 text-white bg-dark">
			<div class="col-sm-6">
